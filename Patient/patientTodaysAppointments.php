...
<div>
    ...
    <div>
      ...
      <div class="Hnav">
          ...
          $_SESSION['pa_name'] = $row['p_name'];
          }
          ?>
<a href="#" style="text-decoration: none !important; color: white; font-size: 20px;"><i class="fas fa-user-circle fa-lg px-2" style="color: white;"></i><span> </span><?php echo $_SESSION['pa_name']?></a>
...
<div class="table-responsive">          
  <table class="table table-bordered table-hover text-center">
    ...
    $sql1 = "SELECT * FROM appointment WHERE p_id = '$p_id' AND DATE(apt_date)=CURDATE()";
    $result1 = mysqli_query($conn,$sql1);
    $nums = mysqli_num_rows($result1);
    while($rowq = mysqli_fetch_array($result1))
    {
        $d_id = $rowq['d_id'];
        $sql2 = "SELECT d_name FROM doctor WHERE d_id = '$d_id' ";
