...
<head>
    ...
    <link href="/F:/HMS/my/fontawesome-free-5.15.2-web/css/all.css" rel="stylesheet">
    ...
    <div class="bgimg">
        ...
        <div class="container text-center content">
          <h1 class="container text-center" style="margin-bottom: 15%; margin-top: 10%;">Welcome to Hospital Management System</h1>
            ...
            <button type="button" class="btn btn-outline-danger Button">Book Appointment</button>
        </div>
