...
<head>
	...
	<script src="bootstrap-4.5.3-dist\DataTables-1.10.24\js\tapt_table.js"></script>
	<script>
		function doSomething(data) {
			...
			$('#update_status').load('update_today.php', {
				form_submit: submit,
				apt_id: id,
				apt_status: status
			});
...
<body>
	...
	$sql = "SELECT appointment.apt_id,doctor.d_name,appointment.apt_name,appointment.apt_email, appointment.apt_mobile,appointment.apt_date, appointment.apt_slot,appointment.apt_status FROM appointment INNER JOIN doctor ON appointment.d_id=doctor.d_id WHERE date(appointment.apt_date)=CURDATE()";

	$result = $mysqli->query($sql);
	$mysqli->close();

	$allSlots = array("s1"=>"09:00AM - 10:00AM","s2"=>"10:00AM - 11:00AM","s3"=>"11:00AM - 12:00PM","s4"=>"12:00PM - 01:00PM",
	"s5"=>"02:00PM - 03:00PM","s6"=>"03:00PM - 04:00PM","s7"=>"04:00PM - 05:00PM");
